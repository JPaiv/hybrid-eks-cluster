...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | External-DNS Helm Chart version -- ref: https://artifacthub.io/packages/helm/external-dns/external-dns | `string` | n/a | yes |
