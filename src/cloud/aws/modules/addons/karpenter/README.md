...
|------|-------------|------|---------|:--------:|
| <a name="input_chart_version"></a> [chart\_version](#input\_chart\_version) | Helm chart version -- ref: https://gallery.ecr.aws/karpenter/karpenter | `string` | n/a | yes |
| <a name="input_cluster_endpoint"></a> [cluster\_endpoint](#input\_cluster\_endpoint) | EKS Cluster id/name; same as the id\_label | `string` | n/a | yes |
...
| <a name="input_node_role_arn"></a> [node\_role\_arn](#input\_node\_role\_arn) | n/a | `string` | `"EKS Node Role ARN from the EKS module"` | no |
| <a name="input_node_role_name"></a> [node\_role\_name](#input\_node\_role\_name) | n/a | `string` | `"EKS Node Role Name from the EKS module"` | no |
