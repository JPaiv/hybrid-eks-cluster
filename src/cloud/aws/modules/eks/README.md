...
| [aws_eks_access_entry.jpaiv](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_access_entry) | resource |
...
| [aws_eks_access_policy_association.jpaiv](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_access_policy_association) | resource |
...
| [aws_eks_addon.metrics](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/eks_addon) | resource |
...
| <a name="input_id_label"></a> [id\_label](#input\_id\_label) | A unique, consistent label used to identify resources across the infrastructure. | `string` | n/a | yes |
| <a name="input_private_subnet_ids"></a> [private\_subnet\_ids](#input\_private\_subnet\_ids) | List of private subnet IDs from the VPC module. | `list(string)` | n/a | yes |
| <a name="input_public_subnet_ids"></a> [public\_subnet\_ids](#input\_public\_subnet\_ids) | List of public subnet IDs from the VPC module. | `list(string)` | n/a | yes |
